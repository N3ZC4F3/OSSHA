...
<i class="fa fa-dashboard" ></i>  Panel de Control / Editar Acerca de Nosotros
...
<label class="col-md-3 control-label"> Breve Descripción : </label>
...
echo "<script>alert('Acerca de Nosotros ha sido actualizado')</script>";
