...
<i class="fa fa-dashboard"> </i> Panel de Control / Editar Paquete
...
Ejemplo de URL de Paquete : cloro-jabonoso
...
<label class="col-md-3 control-label" > Categoría del Producto </label>
...
<label class="col-md-3 control-label" > Imagen 1 del Paquete </label>
...
<label class="col-md-3 control-label" > Imagen 2 del Paquete </label>
...
<label class="col-md-3 control-label" > Imagen 3 del Paquete </label>
...
<label class="col-md-3 control-label" > Etiqueta del Paquete </label>
...
echo "<script> alert('El paquete ha sido actualizado satisfactoriamente ') </script>";
