...
<label class="col-md-3 control-label">Mostrar como Categoría más buscada</label>
...
<label class="col-md-3 control-label">Seleccionar Imagen de la Categoría</label>
...
echo "<script>alert('La Categoría ha sido actualizada')</script>";
