...
<i class="fa fa-dashboard" ></i> Panel de Control / Editar Contáctenos
...
<i class="fa fa-money fa-fw"></i> Editar Contáctenos
...
<label class="col-md-3 control-label"> Correo de contacto: </label>
...
<label class="col-md-3 control-label"> Encabezado de Contacto: </label>
...
echo "<script>alert('La página de Contáctenos ha sido actualizada')</script>";
