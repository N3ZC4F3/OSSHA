...
<i class="fa fa-dashboard"> </i> Panel de Control / Editar cupón
...
<label class="col-md-3 control-label"> Código del Cupón </label>
...
<label class="col-md-3 control-label"> Límite del Cupón </label>
...
<label class="col-md-3 control-label"> Seleccionar Cupón del Producto o Paquete </label>
...
echo "<script>alert('El Cupón ha sido actualizado')</script>";
