...
<i class="fa fa-money fa-fw" ></i> Editar Categoría de Producto
...
<label class="col-md-3 control-label" >Mostrar como la Categoría de Producto más buscada</label>
...
echo "<script>alert('La Categoría del Producto ha sido actualizada')</script>";
