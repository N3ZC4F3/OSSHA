...
<i class="fa fa-dashboard" ></i> Panel de Control / Editar Tienda
...
<label class="col-md-3 control-label"> Imagen de Tienda : </label>
...
<label class="col-md-3 control-label"> Botón de la Tienda : </label>
...
echo "<script>alert('La columna de la Relación ha sido actualizada')</script>";
