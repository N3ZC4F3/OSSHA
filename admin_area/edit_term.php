...
<label class="col-md-3 control-label"> Título de los Términos </label>
...
<label class="col-md-3 control-label"> Descripción de los Términos </label>
...
<label class="col-md-3 control-label"> Link de los Términos </label>
...
echo "<script>alert('Los Términos han sido actualizados')</script>";
