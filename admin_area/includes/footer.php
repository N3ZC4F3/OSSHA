<footer class="page-footer">
		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--info">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Cookies de &amp; Privacidad</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				<div class="footer-nav__heading">¿Por qué comprar en OSSHA?
				</div>
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Envío y &amp; Devoluciones</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Seguimiento deL Pedido</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--lookbook">
				<div class="footer-nav__heading">Catálogo</div>
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Últimas Publicaciones</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Productos del Catálogo</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Artículos del Catálogo</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Catálogo RSS feed</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Ver tu Catálogo</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Borrar tu Catálogo</a>
					</li>
				</ul>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>OSSHA, C.A</span><br> Productos de limpieza, 2023.
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2023 OSSHA&trade;
			</div>

			<div class="developer">
				Desarrollado por Nadgirah Salazar
			</div>
