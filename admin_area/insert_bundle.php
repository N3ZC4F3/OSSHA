...
<i class="fa fa-dashboard"> </i> Panel de Control / Insertar Paquete
...
Ejemplo de URL del Paquete : cloro-jabonoso
...
echo "<script>alert('El Paquete ha sido agregado satisfatoriamente')</script>";
