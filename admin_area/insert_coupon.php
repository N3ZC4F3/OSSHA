...
<i class="fa fa-dashboard"> </i> Panel de Control / Insertar Cupón
...
<label class="col-md-3 control-label">Seleccione Cupón para Producto o Paquete</label>
...
<option>Seleccione el Cupón para el Paquete</option>
...
echo "<script>alert('Un nuevo Cupón ha sido agregado)</script>";
