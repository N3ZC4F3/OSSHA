...
<i class="fa fa-dashboard"></i> Panel de Control / Inserte Referencia del Fabricante
...
<i class="fa fa-money fa-fw"> </i> Inserte Referencia del Fabricante
...
<label class="col-md-3 control-label"> Mostrar entre los Fabricantes Principales </label>
...
echo "<script>alert('Un nuevo Fabricante ha sido agregado')</script>";
