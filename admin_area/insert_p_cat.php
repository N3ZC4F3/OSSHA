...
<i class="fa fa-dashboard"></i> Panel de Control / Insertar Categoría de Productos
...
<label class="col-md-3 control-label" >Mostrar como Categoría de Producto Principal</label>
...
echo "<script>alert('La Categoría del Producto ha sido agregada')</script>";
