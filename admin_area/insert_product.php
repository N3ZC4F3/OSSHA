...
<i class="fa fa-dashboard"> </i> Panel de control / Insertar productos
</li>
...
Ejemplo de URL del producto: cloro-jabonoso
...
<option> Seleccionar una Categoría del Producto </option>
...
echo "<script>alert('El producto ha sido agregado satisfactoriamente')</script>";
