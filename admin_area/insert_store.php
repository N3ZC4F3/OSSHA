...
<i class="fa fa-dashboard" ></i> Panel de control / Insertar Tienda
...
<label class="col-md-3 control-label"> Imagen de la Tienda : </label>
...
echo "<script>alert('Ya has insertado 3 columnas de tienda')</script>";
...
echo "<script>alert('La Columna de la Tienda ha sido agregado satisfactoriamente')</script>";
