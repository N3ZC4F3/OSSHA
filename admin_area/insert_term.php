...
<i class="fa fa-dashboard"></i> Panel de control / Insertar Términos
...
<label class="col-md-3 control-label"> Enlace del Término</label>
...
echo "<script>alert('Los nuevos Términos han sido agregados satisfactoriamente')</script>";
