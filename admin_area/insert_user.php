...
<label class="col-md-3 control-label">Correo de Usuario: </label>
...
<label class="col-md-3 control-label">Trabajo del Usuario: </label>
...
<label class="col-md-3 control-label">Contacto del Usuario: </label>
...
<label class="col-md-3 control-label">Imagen del Usuario: </label>
...
echo "<script>alert('El Usuario ha sido agregado satisfactoriamente')</script>";
