...
<label class="col-md-3 control-label">Correo del Usuario: </label>
...
<label class="col-md-3 control-label">Contraseña del Usuario: </label>
...
<label class="col-md-3 control-label">Trabajo del Usario: </label>
