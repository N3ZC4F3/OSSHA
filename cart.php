  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Carrito de</span> la Tienda
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > Actualmente tienes <?php echo $count; ?> Artículo(s) en tu Carrito. </p>
...
echo "<script>alert('Su código de cupón ha expirado')</script>";
...
echo "<script>alert('Su Código de cupón ha sido aplicado')</script>";
...
<h3 class="text-center"> Quizás te gusten estos productos </h3>
