  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Mi </span>Cuenta
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<strong> ¡Advertencia! </strong> Por favor confirme su correo electrónico y si no ha recibido su correo electrónico de confirmación
...
echo "<script>alert('Tu Cprreo Electrónico ha sido confirmado')</script>";
...
<h2>
Confirmación de correo por Computerfever.com $c_name
</h2>

<a href='localhost/ecom_store/customer/my_account.php?$customer_confirm_code'>

Hacer Click Aquí para confirmar tu Correo
...
echo "<script>alert('Tu confirmación de correo electrónico se te ha enviado. Revisa tu correo')</script>";
