  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Regístra</span> tu Cuenta
      </div>
      <p class="nero__text">
      </p>
    </div>
...
Haz Click aquí para confirmar tu correo
...
echo "<script>alert('Seleccione el Captcha. Por Favor, inténtelo de nuevo')</script>";
