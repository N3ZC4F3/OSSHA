  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Vista del </span> Producto
      </div>
      <p class="nero__text">
      </p>
    </div>
...
echo "<script>alert('Este producto ya está agregado al carrito')</script>";
...
<option>Selecionar Cantidad</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<label class="col-md-5 control-label" >Peso del producto</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_size" class="form-control" >

<option>Seleccionar un Peso</option>
<option>1 litro</option>
<option>2 litros</option>
<option>3 litros</option>
<option>4 litros</option>
<option>5 litros</option>
<option>6 litros</option>
<option>7 litros</option>
<option>8 litros</option>
<option>9 litros</option>
<option>10 litros</option>
...
<label class="col-md-5 control-label" >Peso del paquete</label>
...
<i class="fa fa-heart" ></i> Agregar a la Lista de Deseos
...
<h3 class="text-center"> También te pueden interesar estos productos: Le proporcionamos los 3 mejores productos. </h3>
...
<h3 class="text-center"> Productos agrupados </h3>
