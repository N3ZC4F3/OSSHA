...
<a href="order.php?c_id=<?php echo $customer_id; ?>">Pagar Fuera de Línea</a>
...
<center><!-- center Starts -->
  ...
  <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynow_LG.gif" border="0" name="submit" alt="¡PayPal - La forma más fácil y segura de pagar en línea!">
